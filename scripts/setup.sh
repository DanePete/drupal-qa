...
echo "        for existing projects with a lot of legacy code."
echo "    3 - Adds return type checks and phpdoc validation. If you're starting"
echo "        a new module from scratch, start here — it's way easier to stay"
echo "        clean from the beginning than to retrofit later."
...
echo ""
echo "  Tip: AI tools are great at upgrading existing code to pass higher"
echo "  levels. Start at 1, then ask AI to fix all the errors at each level"
echo "  as you bump it up. See the README for prompts."
echo ""
...
echo "========================================"
echo ""
echo "1. Set these GitHub repo secrets (Settings > Secrets > Actions):"
...
echo ""
echo "2. Create a branch, commit, and open a PR to test it:"
echo "   git checkout -b setup/drupal-qa"
echo "   git add ."
echo "   git commit -m 'feat: add drupal-qa CI/QA toolchain'"
echo "   git push -u origin setup/drupal-qa"
echo ""
echo "   Then open a PR on GitHub. The workflows will run automatically."
echo "   You should see PR Checks, Multidev, and Security Scan kick off."
echo ""
echo "Done."
